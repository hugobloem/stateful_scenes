...
DEFAULT_DATA = {
    CONF_SCENE_PATH: DEFAULT_SCENE_PATH,
    CONF_NUMBER_TOLERANCE: DEFAULT_NUMBER_TOLERANCE,
    CONF_RESTORE_STATES_ON_DEACTIVATE: DEFAULT_RESTORE_STATES_ON_DEACTIVATE,
    CONF_TRANSITION_TIME: DEFAULT_TRANSITION_TIME,
    CONF_EXTERNAL_SCENE_ACTIVE: DEFAULT_EXTERNAL_SCENE_ACTIVE,
    CONF_DEBOUNCE_TIME: DEFAULT_DEBOUNCE_TIME,
    CONF_ENABLE_DISCOVERY: DEFAULT_ENABLE_DISCOVERY,
}
